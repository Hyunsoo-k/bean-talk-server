...
const deleteCommentMiddleware = async (req: Request, res: Response, next: NextFunction): Promise<any> => {
  ...
  if (!comment) {
    ...
    throw new HttpError(404, "권한이 없습니다.");
...
export default deleteCommentMiddleware;
